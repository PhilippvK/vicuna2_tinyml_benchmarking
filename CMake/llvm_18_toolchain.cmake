...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} --target=riscv32 -march=${RISCV_ARCH}${RISCV_ARCH_VL} -mabi=${RISCV_ABI} -fno-exceptions -fno-threadsafe-statics")
...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} --target=riscv32 -march=${RISCV_ARCH}${RISCV_ARCH_VL} -mabi=${RISCV_ABI} -fno-exceptions -fno-threadsafe-statics")
...
set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} --target=riscv32 -march=${RISCV_ARCH}${RISCV_ARCH_VL} -mabi=${RISCV_ABI} -fno-exceptions -fno-threadsafe-statics")
